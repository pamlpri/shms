      ...
      <div class="card">
          <div class="card-body">
              <table class="table table-striped" id="table1">
                  ...
                  <tbody>
                      <tr>
                          ...
                          <td class="text-center"><a href="${cPath}/lms/absenceView.do" class="badge bg-success white-color">완료</a></td>
                      </tr>
                      <tr>
                          <td class="text-center">2</td>
                          <td class="text-center">2345</td>
                          <td class="text-center">군휴학</td>
                          <td class="text-center">2021.05.25</td>
                          <td class="text-center">2022.03.02</td>
                          <td class="text-center">2023.03.02</td>
                      ...
                      <tr>
                          ...
                          <td class="text-center">2023.03.02</td>
                          <td class="text-center">제출완료</td>
                          <th class="text-center"><a href="${cPath}/lms/absenceView.do" class="badge bg-primary white-color">승인</a></th>
                      </tr>
                      <tr>
                          <td class="text-center">1</td>
                          <td class="text-center">2345</td>
                          ...
                          <td class="text-center">2023.03.02</td>
                          <td class="text-center">제출완료</td>
                          <td class="text-center"><a href="${cPath}/lms/absenceForm.do" class="badge bg-info white-color">대기</a></td>
                      </tr>
                      <tr>
                          <td class="text-center">1</td>
                          <td class="text-center">2345</td>
              ...
              <div class="breadcrumb breadcrumb-right">
                  <a href="${cPath}/lms/absenceForm.do" class="btn btn-primary" style="margin-top: -1%;">
                      휴학신청
                  </a>
              </div>
          </div>
