              ...
              <table class="table table-striped" id="table1">
                  ...
                  <tbody>
                      <tr>
                          ...
                          <td class="text-center">간호학과</td>
                          <td class="text-center">S13452235</td>
                          <td class="text-center">송유진</td>
                      ...
                      <tr>
                          ...
                          <td class="text-center">PM 02:00</td>
                          <th class="text-center">
                              <a href="${cPath}/lms/careerCounselingForm.do" class="badge bg-primary">
                                  승인
                              </a>
                          </th>
                      </tr>
