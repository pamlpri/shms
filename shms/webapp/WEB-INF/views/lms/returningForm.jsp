             ...
             <div class="card-body">
                 ...
                 <form>
                     <table class="table table-bordered table-md" style="border-color: #dfdfdf;">
                         ...
                         <tr>
                             <th class="align-middle text-center">직전휴학</th>
                         ...
                         <tr>
                             ...
                             <th class="align-middle text-center">복학일</th>
                             <td class="align-middle">
                                 <input type="date" class="form-control" />
                             </td>
                         </tr>
                     ...
                     <div class="text-center mt-3">
                         <a href="${cPath }/lms/returning.do" class="btn btn-light-secondary">취소</a>
                         <!-- update시에만 보이는 버튼 -->
