      ...
      <div class="card">
          <div class="card-body">
              <table class="table table-striped" id="table1">
                  ...
                  <tbody>
                      <tr>
                          ...
                          <td class="text-center">학사학위취득유예</td>
                          <td class="text-center">2021.05.25</td>
                          <td class="text-center">2022.03.02</td>
                          <td class="text-center">취업준비</td>
                          <td class="text-center">제출완료</td>
                          <td class="text-center"><a href="${cPath}/lms/respiteView.do" class="badge bg-success white-color">완료</a></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                          ...
                          <td class="text-center">취업준비</td>
                          <td class="text-center">제출완료</td>
                          <th class="text-center"><a href="${cPath}/lms/respiteView.do" class="badge bg-primary white-color">승인</a></th>
                      </tr>
                      <tr>
                          <td class="text-center">1</td>
                          <td class="text-center">2345</td>
                          ...
                          <td class="text-center">2021.05.25</td>
                          <td class="text-center">2022.03.02</td>
                          <td class="text-center">개인사유</td>
                          <td class="text-center">제출완료</td>
                          <td class="text-center"><a href="${cPath}/lms/respiteForm.do" class="badge bg-info white-color">대기</a></td>
                      </tr>
                      <tr>
                          <td class="text-center">1</td>
                          <td class="text-center">2345</td>
              ...
              <div class="breadcrumb breadcrumb-right">
                  <a href="${cPath}/lms/respiteForm.do" class="btn btn-primary">
                      학사학위취득유예 신청
                  </a>
              </div>
          </div>
