      ...
      <div class="card-body">
          <div class="table-responsive">
              <table class="table table-bordered table-md" style="border-color: #dfdfdf;">
                  ...
                  <tr>
                      <th rowspan="3" class="align-middle text-center">상담상세</th>
              ...
              <div class="text-center">
                  <a href="${cPath }/lms/careerCounseling.do" class="btn btn-primary">목록으로</a>
                  <!-- 취업장학과만 보이는 버튼 -->
                  <a href="${cPath }/lms/careerCounselingForm.do" class="btn btn-primary">수정</a>
