      ...
      <div class="card">
          <div class="card-body">
              <table class="table table-striped" id="table1">
                  ...
                  <tbody>
                      <tr>
                          ...
                          <td class="text-center">조기졸업</td>
                          <td class="text-center">2021.05.25</td>
                          <td class="text-center">제출완료</td>
                          <td class="text-center"><a href="${cPath}/lms/earlyView.do" class="badge bg-success white-color">완료</a></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                          ...
                          <th class="text-center"><a href="${cPath}/lms/earlyView.do" class="badge bg-primary white-color">승인</a></th>
                      </tr>
                      <tr>
                          ...
                          <td class="text-center">2021.05.25</td>
                          <td class="text-center">제출완료</td>
                          <td class="text-center"><a href="${cPath}/lms/earlyForm.do" class="badge bg-info white-color">대기</a></td>
                      </tr>
                      <tr>
                          <td class="text-center">1</td>
                          <td class="text-center">2345</td>
              ...
              <div class="breadcrumb breadcrumb-right">
                  <a href="${cPath}/lms/earlyForm.do" class="btn btn-primary">
                      조기졸업 신청
                  </a>
              </div>
          </div>
