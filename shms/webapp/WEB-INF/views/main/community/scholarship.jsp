	                    ...
	                    <c:choose>
	                    	<c:when test="${not empty pagingVO.dataList }">
	                         ...
	                         <tr>
	                           ...
	                           <td class="text-center"><a class="text-color" href="${cPath }/main/community/scholarshipView.do?bo_no=${board.bo_no}">${board.bo_title }</a></td>
