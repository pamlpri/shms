...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="errors/images/favicon.png">
    <link href="${cPath }/resources/errors/css/style.css" rel="stylesheet">
...
<%--                                     	</c:choose> --%>
    ...
    <!--**********************************
        Scripts
    ***********************************-->
    <script src="${cPath }/resources/errors/plugins/common/common.min.js"></script>
    <script src="${cPath }/resources/errors/js/custom.min.js"></script>
    <script src="${cPath }/resources/errors/js/settings.js"></script>
    <script src="${cPath }/resources/errors/js/gleek.js"></script>
    <script src="${cPath }/resources/errors/js/styleSwitcher.js"></script>
</body>
</html>
